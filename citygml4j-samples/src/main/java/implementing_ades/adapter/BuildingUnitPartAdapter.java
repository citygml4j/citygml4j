...
@XMLElement(name = "BuildingUnitPart", namespaceURI = TestADEModule.TESTADE_NAMESPACE)
public class BuildingUnitPartAdapter extends AbstractBuildingUnitAdapter<BuildingUnitPart> {

    @Override
    public BuildingUnitPart createObject(QName name, Object parent) throws ObjectBuildException {
    ...
    public Element createElement(BuildingUnitPart object, Namespaces namespaces) throws ObjectSerializeException {
        return Element.of(TestADEModule.TESTADE_NAMESPACE, "BuildingUnitPart");
    }
}
