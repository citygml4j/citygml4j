...
Latest release
--------------
The latest stable release of citygml4j is 2.10.3.

Download the citygml4j 2.10.3 release binaries [here](https://github.com/citygml4j/citygml4j/releases/download/v2.10.3/citygml4j-2.10.3.zip). Previous releases are available from the [releases section](https://github.com/citygml4j/citygml4j/releases).
...
dependencies {
  compile 'org.citygml4j:citygml4j:2.10.3'
}
```
