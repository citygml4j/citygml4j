...
Download the citygml4j 2.8.0 release binaries [here](https://github.com/citygml4j/citygml4j/releases/download/v2.8.0/citygml4j-2.8.0.zip). Previous releases are available from the [releases section](https://github.com/citygml4j/citygml4j/releases).
