...
import org.citygml4j.core.model.ade.generic.GenericADEOfDoor;
...
public class DoorAdapter extends AbstractFillingElementAdapter<Door> {
    ...
    @Override
    public Door createObject(QName name, Object parent) throws ObjectBuildException {
        return new Door();
    }
        ...
        if (CityGMLConstants.CITYGML_3_0_CONSTRUCTION_NAMESPACE.equals(name.getNamespaceURI())) {
            ...
            switch (name.getLocalPart()) {
                case "address":
                    ...
                    return;
                case "adeOfDoor":
                    ADEBuilderHelper.addADEProperty(object, GenericADEOfDoor::of, reader);
                    return;
            }
        }
