...
public class WritingCityJSON {
	...
	public static void main(String[] args) throws Exception {
		...
		try (CityJSONWriter writer = out.createCityJSONWriter(new File("SimpleCityJSON.json"))) {
		...
		try (CityGMLWriter writer = cityGMLOut.createCityGMLWriter(new File("SimpleCityGML.gml"))) {
