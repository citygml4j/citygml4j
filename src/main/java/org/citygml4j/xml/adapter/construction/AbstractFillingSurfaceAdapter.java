...
public abstract class AbstractFillingSurfaceAdapter<T extends AbstractFillingSurface> extends AbstractThematicSurfaceAdapter<T> {
    private final QName substitutionGroup = new QName(CityGMLConstants.CITYGML_3_0_CONSTRUCTION_NAMESPACE, "AbstractGenericApplicationPropertyOfAbstractFillingSurface");
