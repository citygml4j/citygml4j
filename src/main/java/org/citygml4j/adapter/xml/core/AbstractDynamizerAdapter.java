...
public abstract class AbstractDynamizerAdapter<T extends AbstractDynamizer> extends AbstractFeatureWithLifespanAdapter<T> {
    ...
    public void buildADEProperty(T object, QName name, XMLReader reader) throws ObjectBuildException, XMLReadException {
        if (!CityGMLBuilderHelper.addADEProperty(name, ADEPropertyOfAbstractDynamizer.class, object.getADEPropertiesOfAbstractDynamizer(),
                GenericADEPropertyOfAbstractDynamizer::of, reader, substitutionGroup))
