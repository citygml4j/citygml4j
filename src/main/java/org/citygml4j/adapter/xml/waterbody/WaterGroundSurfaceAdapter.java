...
public class WaterGroundSurfaceAdapter extends AbstractWaterBoundarySurfaceAdapter<WaterGroundSurface> {
    private final QName[] substitutionGroups = new QName[] {
            new QName(CityGMLConstants.CITYGML_3_0_WATERBODY_NAMESPACE, "AbstractGenericApplicationPropertyOfWaterGroundSurface"),
    ...
    @Override
    public WaterGroundSurface createObject(QName name) {
    ...
    @Override
    public Element createElement(WaterGroundSurface object, Namespaces namespaces) {
