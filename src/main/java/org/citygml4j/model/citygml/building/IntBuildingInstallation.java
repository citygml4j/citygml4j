...
public class IntBuildingInstallation extends AbstractCityObject implements BuildingModuleComponent, StandardObjectClassifier {
	...
	public void addGenericApplicationPropertyOfIntBuildingInstallation(ADEComponent ade) {
		getGenericApplicationPropertyOfIntBuildingInstallation().add(ade);
	}
	...
	public boolean unsetGenericApplicationPropertyOfIntBuildingInstallation(ADEComponent ade) {
		return isSetGenericApplicationPropertyOfIntBuildingInstallation() && this.ade.remove(ade);
	}
	...
	public BoundingShape calcBoundedBy(BoundingBoxOptions options) {
		...
		if (isSetGenericApplicationPropertyOfIntBuildingInstallation()) {
			for (ADEComponent ade : getGenericApplicationPropertyOfIntBuildingInstallation()) {
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new IntBuildingInstallation(), copyBuilder);
	}

	@Override
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		IntBuildingInstallation copy = (target == null) ? new IntBuildingInstallation() : (IntBuildingInstallation)target;
