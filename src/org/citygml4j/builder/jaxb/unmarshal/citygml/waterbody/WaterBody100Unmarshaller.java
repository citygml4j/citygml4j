...
public class WaterBody100Unmarshaller {
	...
	public void unmarshalWaterObject(AbstractWaterObjectType src, WaterObject dest) throws MissingADESchemaException {
		citygml.getCore100Unmarshaller().unmarshalCityObject(src, dest);
	}
	
	public void unmarshalWaterBoundarySurface(AbstractWaterBoundarySurfaceType src, WaterBoundarySurface dest) throws MissingADESchemaException {
		citygml.getCore100Unmarshaller().unmarshalCityObject(src, dest);
