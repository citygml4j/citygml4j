...
public class WaterBody040Unmarshaller {
	...
	public void unmarshalAbstractWaterObject(_WaterObjectType src, AbstractWaterObject dest) throws MissingADESchemaException {
		citygml.getCore040Unmarshaller().unmarshalAbstractCityObject(src, dest);
	}

	public void unmarshalAbstractWaterBoundarySurface(_WaterBoundarySurfaceType src, AbstractWaterBoundarySurface dest) throws MissingADESchemaException {
		citygml.getCore040Unmarshaller().unmarshalAbstractCityObject(src, dest);
