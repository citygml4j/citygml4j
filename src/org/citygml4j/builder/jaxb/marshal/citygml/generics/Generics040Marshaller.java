...
public class Generics040Marshaller {
	...
	public Generics040Marshaller(CityGMLMarshaller citygml) {
		this.citygml = citygml;
		jaxb = citygml.getJAXBMarshaller();
		
		gen = citygml.getCore040Marshaller().getObjectFactory();
	}
	...
	public void marshalAbstractGenericAttribute(AbstractGenericAttribute src, _GenericAttributeType dest) {
		if (src.isSetName())
	...
	public void marshalGenericCityObject(GenericCityObject src, GenericCityObjectType dest) {
		...
		if (src.isSetLod0ImplicitRepresentation())
			dest.setLod0ImplicitRepresentation(citygml.getCore040Marshaller().marshalImplicitRepresentationProperty(src.getLod0ImplicitRepresentation()));
