...
public class CityJSONBuilder {
	...
	public CityJSONMarshaller createCityJSONMarshaller(VerticesBuilder verticesBuilder, TextureVerticesBuilder textureVerticesBuilder) {
		return new CityJSONMarshaller(verticesBuilder, textureVerticesBuilder);
	}
