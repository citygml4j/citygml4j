...
public class MultiLineStringPropertyImpl implements MultiLineStringProperty {
	...
	public void setMultiLineString(MultiLineString multiLineString) {
		if (multiLineString != null)
			multiLineString.setParent(this);
		
		this.multiLineString = multiLineString;
	}

	public void unsetMultiLineString() {
		if (isSetMultiLineString())
			multiLineString.unsetParent();
	...
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		...
		if (isSetMultiLineString()) {
			copy.setMultiLineString((MultiLineString)copyBuilder.copy(multiLineString));
			if (copy.getMultiLineString() == multiLineString)
				multiLineString.setParent(this);
		}
