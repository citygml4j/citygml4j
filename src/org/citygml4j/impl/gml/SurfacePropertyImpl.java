...
public class SurfacePropertyImpl implements SurfaceProperty {
	...
	public void setSurface(AbstractSurface abstractSurface) {
		if (abstractSurface != null)
			abstractSurface.setParent(this);
	...
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		...
		if (isSetSurface()) {
			copy.setSurface((AbstractSurface)copyBuilder.copy(surface));
			if (copy.getSurface() == surface)
