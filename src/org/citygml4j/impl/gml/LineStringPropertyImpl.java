...
public class LineStringPropertyImpl implements LineStringProperty {
	...
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		...
		if (isSetLineString()) {
			copy.setLineString((LineString)copyBuilder.copy(lineString));
			if (copy.getLineString() == lineString)
				lineString.setParent(this);
		}
