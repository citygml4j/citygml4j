...
public class GeometricPrimitivePropertyImpl implements GeometricPrimitiveProperty {
	private AbstractGeometricPrimitive geometricPrimitive;
	...
	public boolean isSetGeometricPrimitive() {
		return geometricPrimitive != null;
	}
	...
	public void setGeometricPrimitive(AbstractGeometricPrimitive abstractGeometricPrimitive) {
		if (abstractGeometricPrimitive != null)
			abstractGeometricPrimitive.setParent(this);
		
		geometricPrimitive = abstractGeometricPrimitive;
	}

	public void unsetGeometricPrimitive() {
		if (isSetGeometricPrimitive())
			geometricPrimitive.unsetParent();
		
		geometricPrimitive = null;
	}
	...
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		...
		if (isSetGeometricPrimitive()) {
			copy.setGeometricPrimitive((AbstractGeometricPrimitive)copyBuilder.copy(geometricPrimitive));
			if (copy.getGeometricPrimitive() == geometricPrimitive)
				geometricPrimitive.setParent(this);
		}
