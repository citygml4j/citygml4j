...
public class MultiCurvePropertyImpl implements MultiCurveProperty {
	...
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		...
		if (isSetMultiCurve()) {
			copy.setMultiCurve((MultiCurve)copyBuilder.copy(multiCurve));
			if (copy.getMultiCurve() == multiCurve)
				multiCurve.setParent(this);
		}
