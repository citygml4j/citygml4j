...
public class MultiSolidPropertyImpl implements MultiSolidProperty {
	private MultiSolid multiSolid;
	...
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		...
		if (isSetMultiSolid()) {
			copy.setMultiSolid((MultiSolid)copyBuilder.copy(multiSolid));
			if (copy.getMultiSolid() == multiSolid)
				multiSolid.setParent(this);
		}
