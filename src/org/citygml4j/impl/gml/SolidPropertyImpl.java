...
public class SolidPropertyImpl implements SolidProperty {
	...
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		...
		if (isSetSolid()) {
			copy.setSolid((AbstractSolid)copyBuilder.copy(solid));
			if (copy.getSolid() == solid)
				solid.setParent(this);
		}
