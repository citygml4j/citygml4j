...
public class MultiGeometryImpl extends AbstractGeometricAggregateImpl implements MultiGeometry {
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new MultiGeometryImpl(), copyBuilder);
	}

	@SuppressWarnings("unchecked")
	@Override
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		MultiGeometry copy = (target == null) ? new MultiGeometryImpl() : (MultiGeometry)target;
