...
public class PremiseNameImpl implements PremiseName {
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new PremiseNameImpl(), copyBuilder);
	}

	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		PremiseName copy = (target == null) ? new PremiseNameImpl() : (PremiseName)target;
