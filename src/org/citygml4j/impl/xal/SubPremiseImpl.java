...
public class SubPremiseImpl implements SubPremise {
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new SubPremiseImpl(), copyBuilder);
	}

	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		SubPremise copy = (target == null) ? new SubPremiseImpl() : (SubPremise)target;
