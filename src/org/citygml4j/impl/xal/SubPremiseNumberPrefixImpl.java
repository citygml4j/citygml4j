...
public class SubPremiseNumberPrefixImpl implements SubPremiseNumberPrefix {
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new SubPremiseNumberPrefixImpl(), copyBuilder);
	}

	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		SubPremiseNumberPrefix copy = (target == null) ? new SubPremiseNumberPrefixImpl() : (SubPremiseNumberPrefix)target;
