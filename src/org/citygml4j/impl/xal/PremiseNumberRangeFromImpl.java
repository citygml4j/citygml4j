...
public class PremiseNumberRangeFromImpl implements PremiseNumberRangeFrom {
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new PremiseNumberRangeFromImpl(), copyBuilder);
	}

	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		PremiseNumberRangeFrom copy = (target == null) ? new PremiseNumberRangeFromImpl() : (PremiseNumberRangeFrom)target;
