...
public class ThoroughfareNumberToContentImpl implements ThoroughfareNumberToContent {
	...
	public ThoroughfareNumberToContentImpl(String string) {
		setString(string);
	}
	...
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		ThoroughfareNumberToContent copy = (target == null) ? new ThoroughfareNumberToContentImpl() : (ThoroughfareNumberToContent)target;
