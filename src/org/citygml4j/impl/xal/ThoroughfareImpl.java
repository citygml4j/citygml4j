...
public class ThoroughfareImpl implements Thoroughfare {
	...
	public void addThoroughfareNumber(ThoroughfareNumber thoroughfareNumber) {
		...
		numberOrRange.add(new ThoroughfareNumberOrRangeImpl(thoroughfareNumber));
	}
	...
	public void addThoroughfareNumberRange(ThoroughfareNumberRange thoroughfareNumberRange) {
		...
		numberOrRange.add(new ThoroughfareNumberOrRangeImpl(thoroughfareNumberRange));
	}
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new ThoroughfareImpl(), copyBuilder);
	}

	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		Thoroughfare copy = (target == null) ? new ThoroughfareImpl() : (Thoroughfare)target;
