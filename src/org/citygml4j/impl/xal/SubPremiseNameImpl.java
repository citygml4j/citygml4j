...
public class SubPremiseNameImpl implements SubPremiseName {
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new SubPremiseNameImpl(), copyBuilder);
	}

	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		SubPremiseName copy = (target == null) ? new SubPremiseNameImpl() : (SubPremiseName)target;
