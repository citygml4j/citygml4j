...
public class SubPremiseNumberSuffixImpl implements SubPremiseNumberSuffix {
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new SubPremiseNumberSuffixImpl(), copyBuilder);
	}

	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		SubPremiseNumberSuffix copy = (target == null) ? new SubPremiseNumberSuffixImpl() : (SubPremiseNumberSuffix)target;
