...
public class ThoroughfareNumberSuffixImpl implements ThoroughfareNumberSuffix {
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new ThoroughfareNumberSuffixImpl(), copyBuilder);
	}

	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		ThoroughfareNumberSuffix copy = (target == null) ? new ThoroughfareNumberSuffixImpl() : (ThoroughfareNumberSuffix)target;
