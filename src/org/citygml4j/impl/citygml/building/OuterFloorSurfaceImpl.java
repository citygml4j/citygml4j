...
public class OuterFloorSurfaceImpl extends AbstractBoundarySurfaceImpl implements OuterFloorSurface {
	private List<ADEComponent> ade;

	public OuterFloorSurfaceImpl() {
		
	}
	
	public OuterFloorSurfaceImpl(BuildingModule module) {
		super(module);
	}
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new OuterFloorSurfaceImpl(), copyBuilder);
	}

	@Override
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		OuterFloorSurface copy = (target == null) ? new OuterFloorSurfaceImpl() : (OuterFloorSurface)target;
