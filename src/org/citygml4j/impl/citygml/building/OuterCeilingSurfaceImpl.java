...
public class OuterCeilingSurfaceImpl extends AbstractBoundarySurfaceImpl implements OuterCeilingSurface {
	private List<ADEComponent> ade;

	public OuterCeilingSurfaceImpl() {
		
	}
	
	public OuterCeilingSurfaceImpl(BuildingModule module) {
		super(module);
	}
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new OuterCeilingSurfaceImpl(), copyBuilder);
	}

	@Override
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		OuterCeilingSurface copy = (target == null) ? new OuterCeilingSurfaceImpl() : (OuterCeilingSurface)target;
