...
public abstract class CityObjectImpl extends AbstractFeatureImpl implements CityObject {
	...
	private List<GenericAttribute> genericAttribute;
	...
	public void addGenericAttribute(GenericAttribute genericAttribute) {
		if (this.genericAttribute == null)
			this.genericAttribute = new ChildList<GenericAttribute>(this);
	...
	public List<GenericAttribute> getGenericAttribute() {
		if (genericAttribute == null)
			genericAttribute = new ChildList<GenericAttribute>(this);
	...
	public void setGenericAttribute(List<GenericAttribute> genericAttribute) {
		this.genericAttribute = new ChildList<GenericAttribute>(this, genericAttribute);
	}
	...
	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		...
		CityObject copy = (CityObject)target;		
		...
		if (isSetGenericAttribute()) {
			for (GenericAttribute part : genericAttribute) {
				GenericAttribute copyPart = (GenericAttribute)copyBuilder.copy(part);
