...
public class Appearance040ModelMapperImpl extends AbstractCityGMLModelMapperImpl {
	...
	public JAXBElement<? extends GeoreferencedTextureType> toJAXB(GeoreferencedTexture georeferencedTexture) {
		if (!(georeferencedTexture instanceof ADEComponent))
			return ObjectFactory.CITYGML_0_4.createGeoreferencedTexture(((GeoreferencedTextureImpl)georeferencedTexture).getJAXBObject());
		else
	...
	public JAXBElement<? extends ParameterizedTextureType> toJAXB(ParameterizedTexture parameterizedTexture) {
		if (!(parameterizedTexture instanceof ADEComponent))
			return ObjectFactory.CITYGML_0_4.createParameterizedTexture(((ParameterizedTextureImpl)parameterizedTexture).getJAXBObject());
		else
	...
	public JAXBElement<? extends X3DMaterialType> toJAXB(X3DMaterial x3DMaterial) {
		if (!(x3DMaterial instanceof ADEComponent))
			return ObjectFactory.CITYGML_0_4.createX3DMaterial(((X3DMaterialImpl)x3DMaterial).getJAXBObject());
		else
