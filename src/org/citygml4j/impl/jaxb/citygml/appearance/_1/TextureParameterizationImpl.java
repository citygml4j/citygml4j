...
public abstract class TextureParameterizationImpl extends AbstractGMLImpl implements TextureParameterization {
	private AbstractTextureParameterizationType textureParameterizationType;

	public TextureParameterizationImpl(AbstractTextureParameterizationType textureParameterizationType) {
		super(textureParameterizationType);
		this.textureParameterizationType = textureParameterizationType;
	}

	@Override
	public AbstractTextureParameterizationType getJAXBObject() {
