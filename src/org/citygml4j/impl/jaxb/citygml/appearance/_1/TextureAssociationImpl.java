...
public class TextureAssociationImpl extends CityGMLBaseImpl implements TextureAssociation {
	...
	public TextureParameterization getTextureParameterization() {
		if (textureAssociationType.isSet_TextureParameterization()) {
			JAXBElement<? extends AbstractTextureParameterizationType> elem = textureAssociationType.get_TextureParameterization();
	...
	public void setTextureParameterization(TextureParameterization textureParameterization) {
		JAXBElement<? extends AbstractTextureParameterizationType> jaxbElem = null;

		switch (textureParameterization.getCityGMLClass()) {
		case TEXCOORDLIST:
			jaxbElem = ObjectFactory.APP_1.createTexCoordList(((TexCoordListImpl)textureParameterization).getJAXBObject());
			break;
		case TEXCOORDGEN:
			jaxbElem = ObjectFactory.APP_1.createTexCoordGen(((TexCoordGenImpl)textureParameterization).getJAXBObject());
			break;
		}
