...
public abstract class BoundarySurfaceImpl extends CityObjectImpl implements BoundarySurface {
	private AbstractBoundarySurfaceType boundarySurfaceType;

	public BoundarySurfaceImpl(AbstractBoundarySurfaceType boundarySurfaceType) {
		super(boundarySurfaceType);
		this.boundarySurfaceType = boundarySurfaceType;
	}

	@Override
	public AbstractBoundarySurfaceType getJAXBObject() {
