...
public class Building100ModelMapperImpl extends AbstractCityGMLModelMapperImpl {
	...
	public AbstractBuilding toCityGML(AbstractBuildingType abstractBuilding, QName name) {		
		// we are just checking ADEs
		return (AbstractBuilding)jaxb2ade(abstractBuilding, name, AbstractBuilding.class);
	}
	
	public BoundarySurface toCityGML(AbstractBoundarySurfaceType boundarySurface, QName name) {		
		// we are just checking ADEs
		return (BoundarySurface)jaxb2ade(boundarySurface, name, BoundarySurface.class);
	}
	
	public Opening toCityGML(AbstractOpeningType opening, QName name) {		
		// we are just checking ADEs
	...
	public JAXBElement<? extends BuildingType> toJAXB(Building building) {
		if (!(building instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createBuilding(((BuildingImpl)building).getJAXBObject());
		else
	...
	public JAXBElement<? extends BuildingPartType> toJAXB(BuildingPart buildingPart) {
		if (!(buildingPart instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createBuildingPart(((BuildingPartImpl)buildingPart).getJAXBObject());
		else
	...
	public JAXBElement<? extends BuildingFurnitureType> toJAXB(BuildingFurniture buildingFurniture) {
		if (!(buildingFurniture instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createBuildingFurniture(((BuildingFurnitureImpl)buildingFurniture).getJAXBObject());
		else
	...
	public JAXBElement<? extends BuildingInstallationType> toJAXB(BuildingInstallation buildingInstallation) {
		if (!(buildingInstallation instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createBuildingInstallation(((BuildingInstallationImpl)buildingInstallation).getJAXBObject());
		else
	...
	public JAXBElement<? extends IntBuildingInstallationType> toJAXB(IntBuildingInstallation intBuildingInstallation) {
		if (!(intBuildingInstallation instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createIntBuildingInstallation(((IntBuildingInstallationImpl)intBuildingInstallation).getJAXBObject());
		else
	...
	public JAXBElement<? extends CeilingSurfaceType> toJAXB(CeilingSurface ceilingSurface) {
		if (!(ceilingSurface instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createCeilingSurface(((CeilingSurfaceImpl)ceilingSurface).getJAXBObject());
		else
	...
	public JAXBElement<? extends ClosureSurfaceType> toJAXB(ClosureSurface closureSurface) {
		if (!(closureSurface instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createClosureSurface(((ClosureSurfaceImpl)closureSurface).getJAXBObject());
		else
	...
	public JAXBElement<? extends FloorSurfaceType> toJAXB(FloorSurface floorSurface) {
		if (!(floorSurface instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createFloorSurface(((FloorSurfaceImpl)floorSurface).getJAXBObject());
		else
	...
	public JAXBElement<? extends GroundSurfaceType> toJAXB(GroundSurface groundSurface) {
		if (!(groundSurface instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createGroundSurface(((GroundSurfaceImpl)groundSurface).getJAXBObject());
		else
	...
	public JAXBElement<? extends InteriorWallSurfaceType> toJAXB(InteriorWallSurface interiorWallSurface) {
		if (!(interiorWallSurface instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createInteriorWallSurface(((InteriorWallSurfaceImpl)interiorWallSurface).getJAXBObject());
		else
	...
	public JAXBElement<? extends RoofSurfaceType> toJAXB(RoofSurface roofSurface) {
		if (!(roofSurface instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createRoofSurface(((RoofSurfaceImpl)roofSurface).getJAXBObject());
		else
	...
	public JAXBElement<? extends WallSurfaceType> toJAXB(WallSurface wallSurface) {
		if (!(wallSurface instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createWallSurface(((WallSurfaceImpl)wallSurface).getJAXBObject());
		else
	...
	public JAXBElement<? extends RoomType> toJAXB(Room room) {
		if (!(room instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createRoom(((RoomImpl)room).getJAXBObject());
		else
	...
	public JAXBElement<? extends DoorType> toJAXB(Door door) {
		if (!(door instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createDoor(((DoorImpl)door).getJAXBObject());
		else
	...
	public JAXBElement<? extends WindowType> toJAXB(Window window) {
		if (!(window instanceof ADEComponent))
			return ObjectFactory.BLDG_1.createWindow(((WindowImpl)window).getJAXBObject());
		else
			return ade2jaxb((ADEComponent)window, WindowType.class);
	}
	
	public JAXBElement<? extends AbstractBuildingType> toJAXB(AbstractBuilding abstractBuilding) {
		// we are just checking ADEs
		if (abstractBuilding instanceof ADEComponent)
			return ade2jaxb((ADEComponent)abstractBuilding, AbstractBuildingType.class);
		
		return null;
	}
	
	public JAXBElement<? extends AbstractBoundarySurfaceType> toJAXB(BoundarySurface boundarySurface) {
		// we are just checking ADEs
		if (boundarySurface instanceof ADEComponent)
			return ade2jaxb((ADEComponent)boundarySurface, AbstractBoundarySurfaceType.class);
		
		return null;
	}
	
	public JAXBElement<? extends AbstractOpeningType> toJAXB(Opening opening) {
		// we are just checking ADEs
		if (opening instanceof ADEComponent)
			return ade2jaxb((ADEComponent)opening, AbstractOpeningType.class);
	...
	public CityGMLBase toCityGML(JAXBElement<?> jaxbElem) {
		...
		if (jaxbElem.getValue() != null) {
			...
			else if (value instanceof AbstractBuildingType)
				cityGMLBase = toCityGML((AbstractBuildingType)value, name);	
			else if (value instanceof AbstractBoundarySurfaceType)
				cityGMLBase = toCityGML((AbstractBoundarySurfaceType)value, name);	
			else if (value instanceof AbstractOpeningType)
				cityGMLBase = toCityGML((AbstractOpeningType)value, name);
		}
