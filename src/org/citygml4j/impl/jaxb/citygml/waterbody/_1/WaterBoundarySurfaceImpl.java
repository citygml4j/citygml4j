...
public abstract class WaterBoundarySurfaceImpl extends CityObjectImpl implements WaterBoundarySurface {
	private AbstractWaterBoundarySurfaceType waterBoundarySurfaceType;

	public WaterBoundarySurfaceImpl(AbstractWaterBoundarySurfaceType waterBoundarySurfaceType) {
		super(waterBoundarySurfaceType);
		this.waterBoundarySurfaceType = waterBoundarySurfaceType;
	}

	@Override
	public AbstractWaterBoundarySurfaceType getJAXBObject() {
