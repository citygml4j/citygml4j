...
public class _AppearancePropertyImpl extends CityGMLBaseImpl implements _AppearanceProperty {
	private _AppearancePropertyType _appearancePropertyType;

	public _AppearancePropertyImpl() {
		_appearancePropertyType = new _AppearancePropertyType();
	}

	public _AppearancePropertyImpl(_AppearancePropertyType _appearancePropertyType) {
	...
	@Override
	public _AppearancePropertyType getJAXBObject() {
	...
	public _Appearance getAppearance() {
		if (_appearancePropertyType.isSet_Appearance()) {
			JAXBElement<? extends _AppearanceType> jaxbElem = _appearancePropertyType.get_Appearance();
	...
	public void setAppearance(_Appearance _appearance) {
		JAXBElement<? extends _AppearanceType> elem = null;

		switch (_appearance.getCityGMLClass()) {
		case _MATERIAL:
			elem = ObjectFactory.CITYGML_0_4.createMaterial(((_MaterialImpl)_appearance).getJAXBObject());
			break;
		case _SIMPLETEXTURE:
			elem = ObjectFactory.CITYGML_0_4.createSimpleTexture(((_SimpleTextureImpl)_appearance).getJAXBObject());
			break;
		}
