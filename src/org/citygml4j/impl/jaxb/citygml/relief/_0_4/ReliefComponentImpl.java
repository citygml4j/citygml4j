...
public abstract class ReliefComponentImpl extends CityObjectImpl implements ReliefComponent {
	private _ReliefComponentType reliefComponentType;

	public ReliefComponentImpl(_ReliefComponentType reliefComponentType) {
		super(reliefComponentType);
		this.reliefComponentType = reliefComponentType;
	}

	@Override
	public _ReliefComponentType getJAXBObject() {
