...
public class LandUse100ModelMapperImpl extends AbstractCityGMLModelMapperImpl {
	...
	public JAXBElement<? extends LandUseType> toJAXB(LandUse landUse) {
		if (!(landUse instanceof ADEComponent))
			return ObjectFactory.LUSE_1.createLandUse(((LandUseImpl)landUse).getJAXBObject());
		else
