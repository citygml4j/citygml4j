...
public class CityFurniture100ModelMapperImpl extends AbstractCityGMLModelMapperImpl {
	...
	public JAXBElement<? extends CityFurnitureType> toJAXB(CityFurniture cityFurniture) {
		if (!(cityFurniture instanceof ADEComponent))
			return ObjectFactory.FRN_1.createCityFurniture(((CityFurnitureImpl)cityFurniture).getJAXBObject());
		else
