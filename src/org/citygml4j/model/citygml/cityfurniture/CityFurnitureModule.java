...
public enum CityFurnitureModule implements CityGMLModule {
	...
	v1_0_0(CoreModule.v1_0_0) {
		public String getNamespaceUri() { return "http://www.opengis.net/citygml/cityfurniture/1.0"; }
		public String getNamespacePrefix() { return "frn"; }
		public String getSchemaLocation() { return "http://schemas.opengis.net/citygml/cityfurniture/1.0/cityFurniture.xsd"; }
	...
	CityFurnitureModule(CityGMLModule... dependencies) {
	...
	public CityGMLModuleType getModuleType() {
		return CityGMLModuleType.CITYFURNITURE;
	}
