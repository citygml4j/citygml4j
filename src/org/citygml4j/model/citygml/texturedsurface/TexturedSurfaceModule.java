...
public enum TexturedSurfaceModule implements CityGMLModule {
	...
	v1_0_0(CoreModule.v1_0_0) {
		public String getNamespaceUri() { return "http://www.opengis.net/citygml/texturedsurface/1.0"; }
		public String getNamespacePrefix() { return "tex"; }
		public String getSchemaLocation() { return "http://schemas.opengis.net/citygml/texturedsurface/1.0/texturedSurface.xsd"; }
	...
	TexturedSurfaceModule(CityGMLModule... dependencies) {
