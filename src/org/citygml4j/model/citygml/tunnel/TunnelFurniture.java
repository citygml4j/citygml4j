 ...
 * 
 * $Id: TunnelFurniture.java 539 2012-11-29 20:34:56Z nagel $
 */
...
public class TunnelFurniture extends AbstractCityObject implements TunnelModuleComponent, StandardObjectClassifier {
	...
	public TunnelFurniture(TunnelModule module) {
		this.module = module;
	}
	...
	public boolean unsetGenericApplicationPropertyOfTunnelFurniture(ADEComponent ade) {
		return isSetGenericApplicationPropertyOfTunnelFurniture() ? this.ade.remove(ade) : false;
	}
