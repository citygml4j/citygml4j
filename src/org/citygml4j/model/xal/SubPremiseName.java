 ...
 * 
 * $Id: SubPremiseName.java 542 2012-11-29 20:56:44Z nagel $
 */
...
public class SubPremiseName implements XAL, GrPostal, Child, Copyable {
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new SubPremiseName(), copyBuilder);
	}

	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		SubPremiseName copy = (target == null) ? new SubPremiseName() : (SubPremiseName)target;
