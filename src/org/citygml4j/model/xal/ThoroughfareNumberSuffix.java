 ...
 * 
 * $Id: ThoroughfareNumberSuffix.java 542 2012-11-29 20:56:44Z nagel $
 */
...
public class ThoroughfareNumberSuffix implements XAL, GrPostal, Child, Copyable {
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new ThoroughfareNumberSuffix(), copyBuilder);
	}

	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		ThoroughfareNumberSuffix copy = (target == null) ? new ThoroughfareNumberSuffix() : (ThoroughfareNumberSuffix)target;
