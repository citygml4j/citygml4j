 ...
 * 
 * $Id: SubPremiseNumberSuffix.java 542 2012-11-29 20:56:44Z nagel $
 */
...
public class SubPremiseNumberSuffix implements XAL, GrPostal, Child, Copyable {
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new SubPremiseNumberSuffix(), copyBuilder);
	}

	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		SubPremiseNumberSuffix copy = (target == null) ? new SubPremiseNumberSuffix() : (SubPremiseNumberSuffix)target;
