 ...
 * 
 * $Id: BuildingName.java 542 2012-11-29 20:56:44Z nagel $
 */
...
public class BuildingName implements XAL, GrPostal, Child, Copyable {
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new BuildingName(), copyBuilder);
	}

	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		BuildingName copy = (target == null) ? new BuildingName() : (BuildingName)target;
