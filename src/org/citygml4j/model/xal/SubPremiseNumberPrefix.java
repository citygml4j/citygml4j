 ...
 * 
 * $Id: SubPremiseNumberPrefix.java 542 2012-11-29 20:56:44Z nagel $
 */
...
public class SubPremiseNumberPrefix implements XAL, GrPostal, Child, Copyable {
	...
	public XALClass getXALClass() {
		return XALClass.SUB_PREMISE_NUMBER_PREFIX;
	}
	...
	public Object copy(CopyBuilder copyBuilder) {
		return copyTo(new SubPremiseNumberPrefix(), copyBuilder);
	}

	public Object copyTo(Object target, CopyBuilder copyBuilder) {
		SubPremiseNumberPrefix copy = (target == null) ? new SubPremiseNumberPrefix() : (SubPremiseNumberPrefix)target;
