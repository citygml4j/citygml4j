...
public class TrafficAreaAdapter extends AbstractThematicSurfaceAdapter<TrafficArea> {
    ...
    @Override
    public TrafficArea createObject(JsonNode node, Object parent) throws CityJSONBuildException {
        return new TrafficArea();
    }

    @Override
    public void buildObject(TrafficArea object, Attributes attributes, JsonNode node, Object parent, CityJSONBuilderHelper helper) throws CityJSONBuildException, CityJSONReadException {
    ...
    @Override
    public String createType(TrafficArea object, CityJSONVersion version) throws CityJSONSerializeException {
        return "TrafficArea";
    }

    @Override
    public void writeObject(TrafficArea object, ObjectNode node, CityJSONSerializerHelper helper) throws CityJSONSerializeException, CityJSONWriteException {
