...
public class MarkingAdapter extends AbstractThematicSurfaceAdapter<Marking> {
    ...
    @Override
    public Marking createObject(JsonNode node, Object parent) throws CityJSONBuildException {
        return new Marking();
    }

    @Override
    public void buildObject(Marking object, Attributes attributes, JsonNode node, Object parent, CityJSONBuilderHelper helper) throws CityJSONBuildException, CityJSONReadException {
    ...
    @Override
    public String createType(Marking object, CityJSONVersion version) throws CityJSONSerializeException {
        return "TransportationMarking";
    }

    @Override
    public void writeObject(Marking object, ObjectNode node, CityJSONSerializerHelper helper) throws CityJSONSerializeException, CityJSONWriteException {
