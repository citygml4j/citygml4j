...
public class TimePrimitivePropertyType {
    ...
    protected JAXBElement<? extends AbstractTimePrimitiveType> _TimePrimitive;
    ...
    /**
     * Ruft den Wert der _TimePrimitive-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    public JAXBElement<? extends AbstractTimePrimitiveType> get_TimePrimitive() {
        return _TimePrimitive;
    }

    /**
     * Legt den Wert der _TimePrimitive-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TimeEdgeType }{@code >}
    ...
    public void set_TimePrimitive(JAXBElement<? extends AbstractTimePrimitiveType> value) {
        this._TimePrimitive = value;
    }

    public boolean isSet_TimePrimitive() {
        return (this._TimePrimitive!= null);
    }
