    ...
    extends AbstractCityObjectType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfBoundarySurface", namespace = "http://www.opengis.net/citygml/tunnel/2.0", type = JAXBElement.class, required = false)
