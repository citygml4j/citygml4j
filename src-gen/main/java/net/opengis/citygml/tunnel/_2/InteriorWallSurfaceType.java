    ...
    extends AbstractBoundarySurfaceType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfInteriorWallSurface", namespace = "http://www.opengis.net/citygml/tunnel/2.0", type = JAXBElement.class, required = false)
