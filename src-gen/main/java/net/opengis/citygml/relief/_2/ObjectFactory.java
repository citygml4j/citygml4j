...
public class ObjectFactory {
    ...
    private final static QName __GenericApplicationPropertyOfReliefFeature_QNAME = new QName("http://www.opengis.net/citygml/relief/2.0", "_GenericApplicationPropertyOfReliefFeature");
    private final static QName __ReliefComponent_QNAME = new QName("http://www.opengis.net/citygml/relief/2.0", "_ReliefComponent");
    private final static QName __GenericApplicationPropertyOfReliefComponent_QNAME = new QName("http://www.opengis.net/citygml/relief/2.0", "_GenericApplicationPropertyOfReliefComponent");
    private final static QName _TINRelief_QNAME = new QName("http://www.opengis.net/citygml/relief/2.0", "TINRelief");
    private final static QName __GenericApplicationPropertyOfTinRelief_QNAME = new QName("http://www.opengis.net/citygml/relief/2.0", "_GenericApplicationPropertyOfTinRelief");
    private final static QName _RasterRelief_QNAME = new QName("http://www.opengis.net/citygml/relief/2.0", "RasterRelief");
    private final static QName __GenericApplicationPropertyOfRasterRelief_QNAME = new QName("http://www.opengis.net/citygml/relief/2.0", "_GenericApplicationPropertyOfRasterRelief");
    private final static QName _MassPointRelief_QNAME = new QName("http://www.opengis.net/citygml/relief/2.0", "MassPointRelief");
    private final static QName __GenericApplicationPropertyOfMassPointRelief_QNAME = new QName("http://www.opengis.net/citygml/relief/2.0", "_GenericApplicationPropertyOfMassPointRelief");
    private final static QName _BreaklineRelief_QNAME = new QName("http://www.opengis.net/citygml/relief/2.0", "BreaklineRelief");
    private final static QName __GenericApplicationPropertyOfBreaklineRelief_QNAME = new QName("http://www.opengis.net/citygml/relief/2.0", "_GenericApplicationPropertyOfBreaklineRelief");
    private final static QName _Elevation_QNAME = new QName("http://www.opengis.net/citygml/relief/2.0", "Elevation");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.opengis.citygml.relief._2
     * 
     */
