    ...
    extends AbstractCityObjectType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfVegetationObject", namespace = "http://www.opengis.net/citygml/vegetation/2.0", type = JAXBElement.class, required = false)
