    ...
    extends AbstractVegetationObjectType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfSolitaryVegetationObject", namespace = "http://www.opengis.net/citygml/vegetation/1.0", type = JAXBElement.class, required = false)
