 ...
 * 
 * <p>Java-Klasse für BridgeInstallationType complex type.
 * 
    ...
    extends AbstractCityObjectType
{
     ...
     * For example, to add a new item, do as follows:
     * <pre>
     *    get_GenericApplicationPropertyOfBridgeInstallation().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<JAXBElement<Object>> get_GenericApplicationPropertyOfBridgeInstallation() {
        if (_GenericApplicationPropertyOfBridgeInstallation == null) {
            _GenericApplicationPropertyOfBridgeInstallation = new ArrayList<JAXBElement<Object>>();
        }
    ...
    public boolean isSet_GenericApplicationPropertyOfBridgeInstallation() {
        return ((this._GenericApplicationPropertyOfBridgeInstallation!= null)&&(!this._GenericApplicationPropertyOfBridgeInstallation.isEmpty()));
    }
    ...
    public void set_GenericApplicationPropertyOfBridgeInstallation(List<JAXBElement<Object>> value) {
        this._GenericApplicationPropertyOfBridgeInstallation = value;
    }
