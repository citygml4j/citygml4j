    ...
    extends AbstractSurfaceDataType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfX3DMaterial", namespace = "http://www.opengis.net/citygml/appearance/2.0", type = JAXBElement.class, required = false)
