    ...
    extends AbstractTextureType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfGeoreferencedTexture", namespace = "http://www.opengis.net/citygml/appearance/1.0", type = JAXBElement.class, required = false)
