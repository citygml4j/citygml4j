...
public class AbstractSurfaceDataType
    extends AbstractFeatureType
{

    @XmlElement(defaultValue = "true")
    protected Boolean isFront;
    @XmlElementRef(name = "_GenericApplicationPropertyOfSurfaceData", namespace = "http://www.opengis.net/citygml/appearance/1.0", type = JAXBElement.class, required = false)
