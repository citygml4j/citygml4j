    ...
    extends AbstractTextureParameterizationType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfTexCoordGen", namespace = "http://www.opengis.net/citygml/appearance/1.0", type = JAXBElement.class, required = false)
