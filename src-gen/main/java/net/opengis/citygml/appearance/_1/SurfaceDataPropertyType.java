 ...
 * 				none.
 * 
 * <p>Java-Klasse für SurfaceDataPropertyType complex type.
 * 
 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/appearance/1.0}_SurfaceData"/&gt;
...
public class SurfaceDataPropertyType {
    ...
    @XmlElementRef(name = "_SurfaceData", namespace = "http://www.opengis.net/citygml/appearance/1.0", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends AbstractSurfaceDataType> _SurfaceData;
    @XmlAnyElement
    ...
    /**
     * Ruft den Wert der _SurfaceData-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der _SurfaceData-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link X3DMaterialType }{@code >}
    ...
    public boolean isSet_SurfaceData() {
