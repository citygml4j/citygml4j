    ...
    extends AbstractCityObjectType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfCityFurniture", namespace = "http://www.opengis.net/citygml/cityfurniture/2.0", type = JAXBElement.class, required = false)
