...
public class ObjectFactory {
    ...
    private final static QName __GenericApplicationPropertyOfCityFurniture_QNAME = new QName("http://www.opengis.net/citygml/cityfurniture/1.0", "_GenericApplicationPropertyOfCityFurniture");
