...
package net.opengis.citygml.cityfurniture._1;
 ...
 * 				relations. 
 * 
 * <p>Java-Klasse für CityFurnitureType complex type.
 * 
    ...
    extends AbstractCityObjectType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfCityFurniture", namespace = "http://www.opengis.net/citygml/cityfurniture/1.0", type = JAXBElement.class, required = false)
    protected List<JAXBElement<Object>> _GenericApplicationPropertyOfCityFurniture;
     ...
     * For example, to add a new item, do as follows:
     * <pre>
     *    get_GenericApplicationPropertyOfCityFurniture().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public boolean isSet_GenericApplicationPropertyOfCityFurniture() {
        return ((this._GenericApplicationPropertyOfCityFurniture!= null)&&(!this._GenericApplicationPropertyOfCityFurniture.isEmpty()));
    }

    public void unset_GenericApplicationPropertyOfCityFurniture() {
        this._GenericApplicationPropertyOfCityFurniture = null;
    }
    ...
    public void set_GenericApplicationPropertyOfCityFurniture(List<JAXBElement<Object>> value) {
        this._GenericApplicationPropertyOfCityFurniture = value;
    }
