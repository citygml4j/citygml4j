    ...
    extends AbstractBoundarySurfaceType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfClosureSurface", namespace = "http://www.opengis.net/citygml/building/1.0", type = JAXBElement.class, required = false)
