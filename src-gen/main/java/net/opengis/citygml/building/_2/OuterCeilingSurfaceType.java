    ...
    extends AbstractBoundarySurfaceType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfOuterCeilingSurface", namespace = "http://www.opengis.net/citygml/building/2.0", type = JAXBElement.class, required = false)
