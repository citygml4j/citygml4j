    ...
    extends AbstractBoundarySurfaceType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfFloorSurface", namespace = "http://www.opengis.net/citygml/building/2.0", type = JAXBElement.class, required = false)
