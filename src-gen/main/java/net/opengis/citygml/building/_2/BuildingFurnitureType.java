    ...
    extends AbstractCityObjectType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfBuildingFurniture", namespace = "http://www.opengis.net/citygml/building/2.0", type = JAXBElement.class, required = false)
