...
public class BoundedByWaterSurfacePropertyType {
    ...
    protected JAXBElement<? extends AbstractWaterBoundarySurfaceType> _WaterBoundarySurface;
    @XmlAnyElement
    ...
    public void set_WaterBoundarySurface(JAXBElement<? extends AbstractWaterBoundarySurfaceType> value) {
        this._WaterBoundarySurface = value;
    }

    public boolean isSet_WaterBoundarySurface() {
        return (this._WaterBoundarySurface!= null);
    }
