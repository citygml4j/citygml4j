    ...
    extends AbstractCityObjectType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfWaterBoundarySurface", namespace = "http://www.opengis.net/citygml/waterbody/1.0", type = JAXBElement.class, required = false)
