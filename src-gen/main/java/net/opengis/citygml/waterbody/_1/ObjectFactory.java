 ...
 * generated in the net.opengis.citygml.waterbody._1 package. 
...
public class ObjectFactory {
    ...
    private final static QName __WaterObject_QNAME = new QName("http://www.opengis.net/citygml/waterbody/1.0", "_WaterObject");
    private final static QName __GenericApplicationPropertyOfWaterObject_QNAME = new QName("http://www.opengis.net/citygml/waterbody/1.0", "_GenericApplicationPropertyOfWaterObject");
    private final static QName _WaterBody_QNAME = new QName("http://www.opengis.net/citygml/waterbody/1.0", "WaterBody");
    private final static QName __GenericApplicationPropertyOfWaterBody_QNAME = new QName("http://www.opengis.net/citygml/waterbody/1.0", "_GenericApplicationPropertyOfWaterBody");
    private final static QName __WaterBoundarySurface_QNAME = new QName("http://www.opengis.net/citygml/waterbody/1.0", "_WaterBoundarySurface");
    private final static QName __GenericApplicationPropertyOfWaterBoundarySurface_QNAME = new QName("http://www.opengis.net/citygml/waterbody/1.0", "_GenericApplicationPropertyOfWaterBoundarySurface");
    private final static QName _WaterSurface_QNAME = new QName("http://www.opengis.net/citygml/waterbody/1.0", "WaterSurface");
    private final static QName __GenericApplicationPropertyOfWaterSurface_QNAME = new QName("http://www.opengis.net/citygml/waterbody/1.0", "_GenericApplicationPropertyOfWaterSurface");
    private final static QName _WaterGroundSurface_QNAME = new QName("http://www.opengis.net/citygml/waterbody/1.0", "WaterGroundSurface");
    private final static QName __GenericApplicationPropertyOfWaterGroundSurface_QNAME = new QName("http://www.opengis.net/citygml/waterbody/1.0", "_GenericApplicationPropertyOfWaterGroundSurface");
    private final static QName _WaterClosureSurface_QNAME = new QName("http://www.opengis.net/citygml/waterbody/1.0", "WaterClosureSurface");
    private final static QName __GenericApplicationPropertyOfWaterClosureSurface_QNAME = new QName("http://www.opengis.net/citygml/waterbody/1.0", "_GenericApplicationPropertyOfWaterClosureSurface");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.opengis.citygml.waterbody._1
     * 
     */
