    ...
    extends TransportationComplexType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfSquare", namespace = "http://www.opengis.net/citygml/transportation/2.0", type = JAXBElement.class, required = false)
