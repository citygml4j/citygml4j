    ...
    extends AbstractTransportationObjectType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfTransportationComplex", namespace = "http://www.opengis.net/citygml/transportation/2.0", type = JAXBElement.class, required = false)
