    ...
    extends AbstractCityObjectType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfTransportationObject", namespace = "http://www.opengis.net/citygml/transportation/1.0", type = JAXBElement.class, required = false)
