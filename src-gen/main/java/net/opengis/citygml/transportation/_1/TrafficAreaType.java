    ...
    extends AbstractTransportationObjectType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfTrafficArea", namespace = "http://www.opengis.net/citygml/transportation/1.0", type = JAXBElement.class, required = false)
