...
public class ObjectFactory {
    ...
    private final static QName __GenericApplicationPropertyOfCityModel_QNAME = new QName("http://www.opengis.net/citygml/1.0", "_GenericApplicationPropertyOfCityModel");
    private final static QName _CityObjectMember_QNAME = new QName("http://www.opengis.net/citygml/1.0", "cityObjectMember");
    private final static QName __CityObject_QNAME = new QName("http://www.opengis.net/citygml/1.0", "_CityObject");
    private final static QName __GenericApplicationPropertyOfCityObject_QNAME = new QName("http://www.opengis.net/citygml/1.0", "_GenericApplicationPropertyOfCityObject");
    private final static QName __Site_QNAME = new QName("http://www.opengis.net/citygml/1.0", "_Site");
    private final static QName __GenericApplicationPropertyOfSite_QNAME = new QName("http://www.opengis.net/citygml/1.0", "_GenericApplicationPropertyOfSite");
    private final static QName _Address_QNAME = new QName("http://www.opengis.net/citygml/1.0", "Address");
    private final static QName __GenericApplicationPropertyOfAddress_QNAME = new QName("http://www.opengis.net/citygml/1.0", "_GenericApplicationPropertyOfAddress");
