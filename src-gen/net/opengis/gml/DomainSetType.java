...
public class DomainSetType {
    ...
    protected JAXBElement<? extends AbstractTimeObjectType> _TimeObject;
    ...
    /**
     * Ruft den Wert der _TimeObject-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der _TimeObject-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link AbstractTimeGeometricPrimitiveType }{@code >}
    ...
    public boolean isSet_TimeObject() {
        return (this._TimeObject!= null);
    }
